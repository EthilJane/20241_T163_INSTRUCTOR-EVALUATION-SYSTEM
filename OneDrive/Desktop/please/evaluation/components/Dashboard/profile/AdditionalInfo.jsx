...
const AdditionEmployeInfo = () => {
  const [additionalFormData, setAdditionalFormData] =
    useState(PLACE_HOLDER_IF_EMPTY);
  const [initialFormData, setInitialFormData] = useState(PLACE_HOLDER_IF_EMPTY);
  ...
  useEffect(() => {
    const getAdditionalInfo = async () => {
      try {
        let add_info = (await getInstructorAdditionalInfo()).data;
        if (add_info.college) {
          ...
          <div className="additional-info-form-content">
            <div>
              ...
              <input
                ...
                defaultValue={initialFormData.employee_id}></input>
              ...
              <input
                ...
                defaultValue={initialFormData.department}></input>
            </div>
            <div>
              ...
              <input
                ...
                name={INPUT_NAMES.college}></input>
              ...
              <input
                ...
                type="number"
                maxLength={3}
                defaultValue={initialFormData.total_student}></input>
            </div>
          </div>
          <div>
            <hr></hr>
